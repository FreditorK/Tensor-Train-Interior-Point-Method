...
python maxcut_sketch_cgal.py --config configs/maxcut_6.yaml --track_mem
...
python max_stable_set_sketch_cgal.py --config configs/max_stable_set_6.yaml --track_mem
