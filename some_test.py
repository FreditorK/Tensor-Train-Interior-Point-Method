...
e_tt_1_meas = tt_measure(e_tt_1, np.array([1.0, 1.0, 1.0, 1]), np.array([1.0, 1.0, 0.9, 1]))  # P(x=1| x=1), P(x=-1| x=-1)
...
unweighted_tensor = tt_measure_inv(tt_bool_op(weighted_tensor), np.array([1.0, 1.0, 1.0, 1]), np.array([1.0, 1.0, 0.9, 1]))
print(tt_to_tensor(unweighted_tensor))