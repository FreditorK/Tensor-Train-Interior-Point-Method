...
p = np.array([0.001, 1.0])
print("1", tt_to_tensor(hypothesis))
hypothesis = tt_noise_op(hypothesis, p)
print("2", tt_to_tensor(hypothesis))
const_space.expected_truth = 1.0
...
print("Score:", boolean_criterion(len(hypothesis))(tt_noise_op_inv(hypothesis, p)), tt_inner_prod(hypothesis, hypothesis))