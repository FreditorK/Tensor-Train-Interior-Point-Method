...
print(const_space.projections[0](a))
#print(tt_inner_prod(tt_add(e_1_contradiction, top), tt_add(a, bot)))
print(tt_inner_prod(tt_add(e_1_contradiction, bot_p), tt_add(a, top_p)))
"""
