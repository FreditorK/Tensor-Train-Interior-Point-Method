...
gram_tensor = tt_gram_tensor_matrix(tensor_matrix, index_length)  # row_index + inner results
print("Ranks of gram tensor: ", [c.shape for c in gram_tensor])
#index_sol = tt_conjugate_gradient(gram_tensor, tt_train_b, num_iter=10)
