...
from src.tt_amen import tt_amen, tt_block_mals, TTBlockMatrix, TTBlockVector
...
block_b_tt[1] = b_2_tt
block_b_tt[2] = b_3_tt
sol, _ = tt_block_mals(block_matrix_tt, block_b_tt, tol=1e-7, nswp=10, verbose=True, amen=True)
