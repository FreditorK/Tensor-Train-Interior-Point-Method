...
b_1_tt = tt_rank_reduce(tt_matrix_vec_mul(block_00_tt, tt_random_gaussian([1, 2, 3, 4], shape=(2,))))
b_2_tt = tt_rank_reduce(tt_matrix_vec_mul(block_11_tt, tt_random_gaussian([3, 1, 3, 3], shape=(2,))))
